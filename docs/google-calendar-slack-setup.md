...
1. **対象月**（例: 翌月）の各日について、次の時間帯にカレンダーに予定が入っていない日を「候補日」とする。
   ...
   - **平日**: 19:00以降（19:00〜20:00、最終枠20:00）。同様に **18:30〜20:30** が空いている日。
...
## 8. 候補日の判定（土日祝 9:00-20:00 / 平日 19:00以降）
...
- **平日**: 枠は 19:00以降（19:00〜20:00、最終枠20:00）。カレンダーが **18:30〜20:30** 空いている日を候補とする。
